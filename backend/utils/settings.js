const setting = [
  {
    setting: {
      ...
      post_code: "2030",
      contact: "019579034",
      email: "lunchBowl@gmail.com",
      website: "lunchBowl-admin.vercel.app",
      default_currency: "€",
      default_time_zone: "Europe/London",
      default_date_format: "MMM D, YYYY",
      receipt_size: "57-mm",
      from_email: "sale@lunchBowl.com",
    ...
    setting: {
      ...
      home: {
        ...
        quick_delivery_description: {
          en: "There are many products you will find in our shop, Choose your daily necessary product from our lunchBowl shop and get some special offers. See Our latest discounted products from here and get a special discount.",
          de: "Es gibt viele Produkte, die Sie in unserem Shop finden. Wählen Sie Ihr täglich benötigtes Produkt aus unserem lunchBowl-Shop und erhalten Sie einige Sonderangebote. Sehen Sie sich hier unsere neuesten reduzierten Produkte an und sichern Sie sich einen Sonderrabatt.",
        },
        ...
        daily_need_title: {
          en: "Get Your Daily Needs From Our lunchBowl Store",
          de: "Holen Sie sich Ihren täglichen Bedarf in Ihrem CloudCleaver-Shop",
        },
        daily_need_description: {
          en: "There are many products you will find in our shop, Choose your daily necessary product from our lunchBowl shop and get some special offers.",
          de: "Es gibt viele Produkte, die Sie in unserem Shop finden. Wählen Sie Ihr täglich benötigtes Produkt aus unserem lunchBowl-Shop und erhalten Sie einige Sonderangebote.",
        },
      ...
      about_us: {
        ...
        top_title: {
          en: "Welcome to our lunchBowl shop",
          de: "Willkommen in unserem lunchBowl-Shop",
        },
        top_description: {
      ...
      contact_us: {
        ...
        email_box_email: {
          en: "info@lunchBowl.com ",
          de: "info@lunchBowl.com",
        },
        email_box_text: {
      ...
      faq: {
        ...
        faq_one: {
          en: "How does the lunchBowl work?",
          de: "Wie funktioniert der lunchBowl?",
        },
        description_one: {
        ...
        faq_five: {
          en: "What is lunchBowl EC2 auto scaling?",
          de: "Was ist die automatische Skalierung von lunchBowl EC2?",
        },
        description_five: {
          en: "Continually impact seamless imperatives for best-of-breed best practices. Phosfluorescently facilitate parallel applications with unique imperatives. Proactively plagiarize functionalized deliverables via inexpensive solutions. Collaboratively embrace web-enabled infomediaries rather than diverse testing procedures.",
        ...
        faq_six: {
          en: "What are the benefits of using lunchBowl affliate?",
      ...
      seo: {
        ...
        meta_description:
          "lunchBowlHealthy Bites to Fuel Your Child’s Mind",
        meta_img:
          "https://cdn.pixabay.com/photo/2017/06/02/18/24/fruit-2367029_1280.jpg",
        meta_keywords: "lunchBowl, online store",
        meta_title:
